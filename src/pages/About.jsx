            ...
            <Card className="border-purple-200 dark:border-purple-700">
              <CardContent className="p-6">
                <ul className="space-y-4 text-sm">
                    <li className="flex items-start"><Briefcase className="h-4 w-4 mr-3 mt-1 flex-shrink-0 text-purple-500" /><div><span className="font-semibold text-foreground">Current Role:</span> Looking for remote software engineering position</div></li>
                    <li className="flex items-start"><GraduationCap className="h-4 w-4 mr-3 mt-1 flex-shrink-0 text-purple-500" /><div><span className="font-semibold text-foreground">Education:</span> Studying Software Engineering at Kharazmi University of Tehran </div></li>
