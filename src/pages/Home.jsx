...
// A simple component for the floating shapes
...
const Home = () => {
  usePageTitle('Arshia Shirzad - Backend & AI Developer', 'Arshia Shirzad - Professional Back-End Developer specializing in C#, .NET Core, ASP.NET, and scalable enterprise solutions.')
      ...
      <section className="relative w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Right Visuals - Profile Image with Floating Shapes */}
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <img
                    src="/profile.jpg"
                    alt="Arshia Shirzad"
                    className="w-80 h-80 object-cover rounded-3xl shadow-2xl shadow-black/20 dark:shadow-black/50 border-2 border-purple-200/20 dark:border-purple-800/20"
                  />
                </div>
              </motion.div>
            </div>
